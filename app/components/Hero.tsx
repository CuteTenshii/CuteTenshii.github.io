...
export default function Hero() {
  return (
    <div className="relative flex items-center justify-center text-center gap-4 h-[80vh] px-8 max-md:flex-col lg:flex-col">
      <Image
        src={pfp} alt="Avatar" className="mx-auto mb-3 size-48 rounded-full" draggable={false} width={192} height={192}
      />
      <div className="flex flex-col items-center max-w-2xl">
        ...
        <p className="text-lg">
          ...
          <a href="https://miwa.lol" target="_blank" className="space-x-2">
            ...
            />
            <span>Miwa.lol</span>
          </a>, a modern and customizable link-in-bio website, and is a good alternative to Linktree and others!
        </p>
        <span className="text-sm mt-0.5 md:mt-1.5 text-gray-400">Trusted by more than 1,6k users, and still growing!</span>
      </div>
    </div>
  );
}